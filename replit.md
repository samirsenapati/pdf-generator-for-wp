...
- **CHECKBOX SETTINGS FIXED:** Enable Bulk Download and Enable Print Option checkboxes now save correctly
  ...
  - Added proper `name` attributes to ensure form submission
  - Bulk PDF download and print options now persist after saving settings
  - All Icon Display settings now fully functional

**Previous Version:** 2.0.6 (FinalPDF - FinalDoc Company Edition)
