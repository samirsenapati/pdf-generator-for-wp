    ...
    (function (wp) {
        ...
        registerBlockType('wpswings/linkedin-embed', {
            ...
            attributes: {
                ...
                redirectUrl: { type: 'string', default: 'https://docs.wpswings.com/finalpdf/?utm_source=wpswings-pdf-doc&utm_medium=referral&utm_campaign=documentation' }
            },
...
if ('on' === embed_block_param.is_canva_active) {
    (function (wp) {
        ...
        registerBlockType('wpswings/canva-embed', {
            ...
            category: 'wpswings-embeds',
            attributes: {
                canvaUrl: { type: 'string', default: 'https://docs.wpswings.com/finalpdf/?utm_source=wpswings-pdf-doc&utm_medium=referral&utm_campaign=documentation' },
            },
...
if ('on' === embed_block_param.is_reddit_active) {
    (function (wp) {
        ...
        registerBlockType('wpswings/reddit-embed', {
            ...
            category: 'wpswings-embeds',
            attributes: {
                redditUrl: { type: 'string', default: 'https://docs.wpswings.com/finalpdf/?utm_source=wpswings-pdf-doc&utm_medium=referral&utm_campaign=documentation' }
            },
...
if ('on' === embed_block_param.is_loom_active) {
    (function (wp) {
        ...
        registerBlockType('wpswings/loom-embed', {
            ...
            category: 'wpswings-embeds',
            attributes: {
                loomUrl: { type: 'string', default: 'https://docs.wpswings.com/finalpdf/?utm_source=wpswings-pdf-doc&utm_medium=referral&utm_campaign=documentation' }
            },
    ...
    (function (wp) {
        ...
        if (embed_block_param.is_pro_active) {
            registerBlockType('wpswings/pdf-embed', {
                ...
                category: 'wpswings-embeds',
                attributes: {
                    pdfUrl: { type: 'string', default: 'https://docs.wpswings.com/finalpdf/?utm_source=wpswings-pdf-doc&utm_medium=referral&utm_campaign=documentation' }
                },
