...
<div class="wpg-secion-wrap wps_finalpdf_pro_tag">
        <?php

        echo '<form method="POST" action=""><input type="hidden" name="delete_nonce" value="366a82202a"><input type="hidden" id="_wpnonce" name="_wpnonce" value="470d3c82fb"><input type="hidden" name="_wp_http_referer" value="/wp-admin/admin.php?page=finalpdf_menu&amp;finalpdf_tab=finalpdf-logs">       <div class="tablenav top">

        <table class="wp-list-table widefat fixed striped table-view-list wps-plugins_page_finalpdf_menu">
        <thead>
        <tr>
