...
global $finalpdf_obj;
$finalpdf_active_tab   = isset( $_GET['finalpdf_tab'] ) ? sanitize_key( $_GET['finalpdf_tab'] ) : 'finalpdf-header'; // phpcs:ignore
$finalpdf_default_tabs = $finalpdf_obj->wps_finalpdf_plug_default_sub_tabs();
$finalpdf_body_array   = apply_filters( 'finalpdf_body_settings_array', array() );
?>
	...
	<div>
		<form action="" method="POST" class="wps-finalpdf-gen-section-form">
			<div class="finalpdf-secion-wrap">
				...
				$finalpdf_obj->wps_finalpdf_plug_generate_html( $finalpdf_body_array );
				?>
			</div>
		</form>
	</div>
