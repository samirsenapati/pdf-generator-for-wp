...
function wps_embed_sources_page() {
	...
	<div class="wrap">
		<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
			<h1 style="margin:0;"><?php echo esc_html__( 'Embed Sources', 'finalpdf' ); ?></h1>
			<div id="wps-toast-msg">✅ <?php echo esc_html( 'Setting saved!', 'finalpdf' ); ?></div>
		</div>
		<div class="wps-embed-grid">
			...
			foreach ( $sources as $source ) :
				...
				$is_disabled = $is_pro && ( ! is_plugin_active( 'finalpdf/finalpdf.php' ) );
				?>
				<div class="wps-embed-item <?php echo $is_disabled ? 'disabled-item' : ''; ?>">
					<?php if ( $is_disabled ) : ?>
						<div class="wps-pro-strip-embed">PRO</div>
					<?php endif; ?>
					<img width="30" height="30" src=<?php echo esc_url( FINALPDF_DIR_URL . "admin/src/images/{$source}.png" ); ?> alt="linkedin"/>
					...
					<div style="display: flex; justify-content: center; align-items: center; gap: 8px;">
						...
						$title_one = esc_html( sprintf( __( 'Enable this to %s on your posts, pages, or custom post types', 'finalpdf' ), $label ) );

						// translators: %s is a label like "PDF" or "iframe".
						$title_two = esc_html( sprintf( __( 'Enable this to embed %s on your posts, pages, or custom post types', 'finalpdf' ), $label ) );
...
<?php } ?>
		...
		<p style="margin-top: 15px; font-style: italic; color: #666;">
			🔹<?php echo esc_html__( 'Prefer a quick guide ? ', 'finalpdf' ); ?><a href="https://yourwebsite.com/documentation/?utm_source=wpswings-pdf-doc&utm_medium=referral&utm_campaign=documentation" target="_blank"><?php echo esc_html__( 'Check out our documentation to understand how these settings work.', 'finalpdf' ); ?></a>
		</p>
	</div>
