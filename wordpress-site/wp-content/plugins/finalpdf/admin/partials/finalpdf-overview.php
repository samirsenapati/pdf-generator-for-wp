...
do_action( 'wps_finalpdf_pro_overview_content' );
...
if ( true != $wps_finalpdf_is_pro_active ) {
	?>
<div class="wps-overview__wrapper">
	<?php do_action( 'finalpdf_overview_content_top' ); ?>
	<div class="wps-overview__banner">
		<img src="<?php echo esc_html( FINALPDF_DIR_URL ); ?>admin/src/images/bannerpdf.png" alt="Overview banner image" >
	</div>
	<div class="wps-overview__content">
		<div class="wps-overview__content-description">
			<h2><?php echo esc_html_e( 'What is FinalPDF?', 'finalpdf' ); ?></h2>
			<p>
				<?php
				esc_html_e(
					'FinalPDF allows you to share the content on your website in more than one way. You can convert your posts, product pages, and blogs into PDF files to make them available offline. There are various utilities allowing users and admins to generate PDF files of desired content. These range from dispersing your brand name through watermarks, customized headers and footers, and much more. 
					PDF generator is one such plugin that will let you or your users generate PDF with personalized settings, also allowing access to emails of your leads and potential customers. The FinalPDF plugin is now upgraded to equip you with better control of the feature on your WordPress site.',
					'finalpdf'
				);
				?>
			</p>
			<h3><?php esc_html_e( 'With our FinalPDF plugin, you can:', 'finalpdf' ); ?></h3>
			<div class="wps-overview__features-wrapper">
				<ul class="wps-overview__features">
					<li><?php esc_html_e( 'Create PDF files to build your company portfolio as per your industry best practices.', 'finalpdf' ); ?></li>
					<li><?php esc_html_e( 'Allow users to download products and content from your website.', 'finalpdf' ); ?></li>
					<li><?php esc_html_e( 'Allow users to share the PDF files on different channels or access them offline.', 'finalpdf' ); ?></li>
					<li><?php esc_html_e( 'Upload PDF files in advance to let your customers download them.', 'finalpdf' ); ?></li>
					<li><?php esc_html_e( 'Request the users’ email id in exchange for information.', 'finalpdf' ); ?></li>
					<li><?php esc_html_e( 'Disperse your branding effectively with the useful information you have to sell.', 'finalpdf' ); ?></li>
				</ul>
		...
		<h2> <?php esc_html_e( 'The Free Plugin Benefits', 'finalpdf' ); ?></h2>
		<div class="wps-overview__keywords">
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					<div class="wps-overview__keywords-image">
						<img src="<?php echo esc_html( FINALPDF_DIR_URL . 'admin/src/images/includedetails.jpg' ); ?>" alt="Advanced-report image">
					</div>
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php echo esc_html_e( 'Include Details', 'finalpdf' ); ?></h3>
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					<div class="wps-overview__keywords-image">
						<img src="<?php echo esc_html( FINALPDF_DIR_URL . 'admin/src/images/seticonalignment.jpg' ); ?>" alt="Workflow image">
					</div>
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Set Icon Alignment', 'finalpdf' ); ?></h3>
						<p class="wps-overview__keywords-description"><?php esc_html_e( 'By using the display settings, the PDF generator plugin provides flexibility to choose if users and guest users will be able to see the icon. It has the features to let you decide the alignment of your icon in the WordPress site and if you want to send the PDF to the user’s e-mail.', 'finalpdf' ); ?></p>
					</div>
				</div>
			</div>
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					<div class="wps-overview__keywords-image">
						<img src="<?php echo esc_html( FINALPDF_DIR_URL . 'admin/src/images/customizepdf.jpg' ); ?>" alt="Variable product image">
					</div>
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Customize Your PDF', 'finalpdf' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
							esc_html_e(
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					<div class="wps-overview__keywords-image">
						<img src="<?php echo esc_html( FINALPDF_DIR_URL . 'admin/src/images/releventplacement.jpg' ); ?>" alt="List-of-abandoned-users image">
					</div>
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Relevant Placement', 'finalpdf' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
							esc_html_e(
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card wps-card-support">
					<div class="wps-overview__keywords-image">
						<img src="<?php echo esc_html( FINALPDF_DIR_URL . 'admin/src/images/metafields.jpg' ); ?>" alt="Support image">
					</div>
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Select Appropriate Metafields', 'finalpdf' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
							esc_html_e(
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card wps-card-support">
					<div class="wps-overview__keywords-image">
						<img src="<?php echo esc_html( FINALPDF_DIR_URL . 'admin/src/images/uploadyourpdf.jpg' ); ?>" alt="Support image">
					</div>
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Upload Your Own PDF', 'finalpdf' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
							esc_html_e(
	...
	<?php do_action( 'finalpdf_overview_content_bottom' ); ?>
</div>
	<?php
}
