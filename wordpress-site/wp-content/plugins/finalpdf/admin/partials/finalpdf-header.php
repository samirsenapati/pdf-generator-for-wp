...
$finalpdf_settings_header_fields = apply_filters( 'finalpdf_header_settings_array', array() );
?>
	...
	<div>
		<form action="" method="POST" class="wps-finalpdf-gen-section-form">
			<div class="finalpdf-secion-wrap">
				...
				$finalpdf_obj->wps_finalpdf_plug_generate_html( $finalpdf_settings_header_fields );
				?>
			</div>
		</form>
	</div>
