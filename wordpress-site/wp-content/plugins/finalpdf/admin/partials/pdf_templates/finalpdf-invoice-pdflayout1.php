	...
	if ( $order_details ) {
		...
		if ( 'invoice' === $type ) {
					...
					<thead class="background-pdf-color-template">
						<tr class="wpg-invoice-background-color">
							...
							$html .= '<th style="text-align: left;padding: 10px;" class="wpg-invoice-color">
								' . __( 'Price', 'finalpdf' ) . ' ( ' . $billing_details['order_currency'] . ' )
							</th>
							<th style="text-align: left;padding: 10px;" class="wpg-invoice-color">
								' . __( 'Tax', 'finalpdf' ) . '( % )
							</th>
							<th style="text-align: left;padding: 10px;" class="wpg-invoice-color">
								' . __( 'Total', 'finalpdf' ) . ' ( ' . $billing_details['order_currency'] . ' )
							</th>
						</tr>
					</thead>
					<tbody>';
			...
			<tr>
						...
						<td style="padding: 2px 10px;font-weight: bold;">
							' . __( 'Discount', 'finalpdf' ) . ' ( ' . $billing_details['order_currency'] . ' ) 
						</td>
						<td style="padding: 2px 10px;font-weight: bold;">
